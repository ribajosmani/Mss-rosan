...
from NoinoiRobot import LOG_GROUP_ID
from NoinoiRobot import pbot as app 
from NoinoiRobot.modules.memek import arq
from NoinoiRobot.core.keyboard import ikb
from NoinoiRobot.core.tasks import _get_tasks_text, all_tasks, rm_task
from NoinoiRobot.core.types import InlineQueryResultCachedDocument
from NoinoiRobot.modules.info import get_chat_info, get_user_info
from NoinoiRobot.modules.music import download_youtube_audio
from NoinoiRobot.utils.functions import test_speedtest
...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/bc89212382407fd01e327.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url=f"https://t.me/NOINOI_BOT"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[NOINOI❤️](https://t.me/NOINOI_BOT):**
**RoBot:** `{bot_state}`
**UserBot:** `Alive`
...
**Profiles:** [BOT](https://t.me/NOINOI_BOT) | [UBOT](https://t.me/BAZIGARYT)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="CHEAK NOINOI STATS",
...
async def about_function(answers):
    ...
    msg = f"""
[NOINOI ✨](https://t.me/NOINOI_BOT) 
   Maintained by [X](t.me/BAZIGARYT)
Built with using python-telegram-bot v13.7 Running on Python 3.9.7
"""
    answers.append(
        InlineQueryResultArticle(
            title="About",
            description="ABOUT NOINOI",
            thumb_url="https://telegra.ph/file/bc89212382407fd01e327.jpg",
            input_message_content=InputTextMessageContent(
                msg, disable_web_page_preview=True
            ),
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/BAZIGARYT"
    try:
        messages = [
            m
